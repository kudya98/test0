...
const Todo = ({ actions,  id, completed, text }) => (
    <li className={'todo'}
        style={{
            textDecoration: completed ? 'line-through' : 'none',
            backgroundColor: completed ? '#999' : '#ddd'
        }}
    ...
    <p>{text}</p>
        <img
            ...
            onMouseEnter={(e)=>e.currentTarget.parentNode.style.color="red"}
            onMouseLeave={(e)=>e.currentTarget.parentNode.style.color="black"}
        >
        </img>
    </li>
